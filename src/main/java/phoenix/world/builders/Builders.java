...
public class Builders
{
    ...
    public static final AdvansedSurfaceBuilderConfig UNDER_CONFIG     = new AdvansedSurfaceBuilderConfig(Blocks.END_STONE, Blocks.END_STONE, Blocks.END_STONE, PhoenixBlocks.FERTILE_END_STONE.get());
