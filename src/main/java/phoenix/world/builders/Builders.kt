...
{
    //Билдеры
    val UNDER: SurfaceBuilder<AdvansedSurfaceBuilderConfig> = SurfaceBuilder.register("under", UnderSurfaceBuilder { p_215455_0_: Dynamic<*>? -> AdvansedSurfaceBuilderConfig.deserialize(p_215455_0_) })
    ...
    val UNDER_CONFIG = AdvansedSurfaceBuilderConfig(Blocks.END_STONE, Blocks.END_STONE, Blocks.END_STONE, PhoenixBlocks.FERTILE_END_STONE.get())
