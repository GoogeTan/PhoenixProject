...
public class CaudaRenderer extends MobRenderer<CaudaEntity, CaudaModel>
{
    ...
    public ResourceLocation getEntityTexture(CaudaEntity entity)
    {
        return entity.isChild() ?
                new ResourceLocation(Phoenix.MOD_ID, "textures/entity/cauda_child.png")
                    :
                new ResourceLocation(Phoenix.MOD_ID, "textures/entity/cauda.png");
    }
}
