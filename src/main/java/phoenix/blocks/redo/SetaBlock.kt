...
class SetaBlock : Block(Properties.create(Material.CACTUS).notSolid().tickRandomly().harvestTool(ToolType.SHOVEL).lightValue(5)), IGrowable
{
    init
    {
    ...
    /*
    override fun getLightValue(state: BlockState): Int = state.get(AGE_0_3) + 1
