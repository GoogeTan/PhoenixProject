...
{
    val BIOMES = DeferredRegister.create(ForgeRegistries.BIOMES, Phoenix.MOD_ID)

    val UNDER     = BIOMES.register("under", ::UnderBiome)
    val HEARTVOID = BIOMES.register("heart_void", ::HeartVoidBiome)

    fun register() =  BIOMES.register(FMLJavaModLoadingContext.get().modEventBus)
}
