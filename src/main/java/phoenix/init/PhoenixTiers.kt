...
{
    ZIRCONIUM_TIER(3, 1000, 6.0f, 2.0f, 14, Ingredient.fromItems(PhoenixItems.HIGH_QUALITY_CLAY_ITEM.get())),
    STEEL_TIER(2, 1200, 6f, 3.5f, 10, Ingredient.fromItems(PhoenixItems.STEEL_INGOT.get()));
