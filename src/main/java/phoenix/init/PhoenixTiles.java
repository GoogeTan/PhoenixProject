...
public class PhoenixTiles
{
    ...
    public static final RegistryObject<TileEntityType<PotteryBarrelTile>> POTTERY_BARREL = TILE_ENTITIES.register("pottery_barrel",    () -> TileEntityType.Builder.create(PotteryBarrelTile::new,
            PhoenixBlocks.POTTERY_BARREL.get()).build(null));
