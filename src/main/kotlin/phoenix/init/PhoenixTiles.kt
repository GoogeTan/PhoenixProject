...
object PhoenixTiles
{
    ...
    val ELECTRIC_BARREL by TILE_ENTITIES.register("electric_barrel"){ TileEntityType.Builder.create(::ElectricBarrelTile, PhoenixBlocks.POTTERY_BARREL).build(null) }
