package phoenix.client.render.dragon
...
class RedoDragonRenderer(renderManagerIn: EntityRendererManager) :
    EntityRenderer<DragonRedoStageEntity>(renderManagerIn)
{
    private val model = EnderDragonModel()
    override fun render(
        entityIn: DragonRedoStageEntity,
        entityYaw: Float,
        partialTicks: Float,
     ...
     */
    override fun getEntityTexture(entity: DragonRedoStageEntity): ResourceLocation
    {
        return DRAGON_TEXTURES
    }

    @OnlyIn(Dist.CLIENT)
    class EnderDragonModel : EntityModel<DragonRedoStageEntity>()
    {
        ...
        private var dragonInstance: DragonRedoStageEntity? = null
